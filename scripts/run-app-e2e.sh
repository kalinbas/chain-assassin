...
SIM_MIN_ACTIVE_DURATION_SECONDS="${SIM_MIN_ACTIVE_DURATION_SECONDS:-15}"
...
SIM_MAX_DURATION_SECONDS="${SIM_MAX_DURATION_SECONDS:-1200}"
...
if [ "$SKIP_STACK" != "1" ]; then
  ...
  (
    ...
    SIMULATION_PREGAME_DURATION_SECONDS="$PREGAME_DURATION_SECONDS" \
    LOG_LEVEL=info \
...
SIM_MIN_ACTIVE_DURATION_SECONDS=${SIM_MIN_ACTIVE_DURATION_SECONDS}
